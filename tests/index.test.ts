...
import { APIPromise } from 'March-12-Project/api-promise';

import util from 'node:util';
import March12Project from 'March-12-Project';
import { APIUserAbortError } from 'March-12-Project';
...
describe('instantiate client', () => {
  ...
  describe('defaultHeaders', () => {
    const client = new March12Project({
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['MARCH_12_PROJECT_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: March12Project) => {
    ...
    test('debug logs when log level is debug', async () => {
      ...
      const client = new March12Project({ logger: logger, logLevel: 'debug', apiKey: 'My API Key' });
    ...
    test('default logLevel is warn', async () => {
      const client = new March12Project({ apiKey: 'My API Key' });
    ...
    test('debug logs are skipped when log level is info', async () => {
      ...
      const client = new March12Project({ logger: logger, logLevel: 'info', apiKey: 'My API Key' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      process.env['MARCH_12_PROJECT_LOG'] = 'debug';
      const client = new March12Project({ logger: logger, apiKey: 'My API Key' });
    ...
    test('warn when env var level is invalid', async () => {
      ...
      process.env['MARCH_12_PROJECT_LOG'] = 'not a log level';
      const client = new March12Project({ logger: logger, apiKey: 'My API Key' });
      expect(client.logLevel).toBe('warn');
      expect(warnMock).toHaveBeenCalledWith(
        'process.env[\'MARCH_12_PROJECT_LOG\'] was set to "not a log level", expected one of ["off","error","warn","info","debug"]',
      );
    });
    ...
    test('client log level overrides env var', async () => {
      ...
      process.env['MARCH_12_PROJECT_LOG'] = 'debug';
      const client = new March12Project({ logger: logger, logLevel: 'off', apiKey: 'My API Key' });
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['MARCH_12_PROJECT_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new March12Project({ baseURL: 'https://example.com', apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['MARCH_12_PROJECT_BASE_URL'] = 'https://example.com/from_env';
      const client = new March12Project({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty env variable', () => {
      process.env['MARCH_12_PROJECT_BASE_URL'] = ''; // empty
      const client = new March12Project({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://petstore.swagger.io/api');
    });

    test('blank env variable', () => {
      process.env['MARCH_12_PROJECT_BASE_URL'] = '  '; // blank
      const client = new March12Project({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://petstore.swagger.io/api');
    });
  });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new March12Project({ maxRetries: 4, apiKey: 'My API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new March12Project({ apiKey: 'My API Key' });
    expect(client2.maxRetries).toEqual(2);
  });

  test('with environment variable arguments', () => {
    // set options via env var
    process.env['MARCH_12_PROJECT_API_KEY'] = 'My API Key';
    const client = new March12Project();
  ...
  test('with overridden environment variable arguments', () => {
    // set options via env var
    process.env['MARCH_12_PROJECT_API_KEY'] = 'another My API Key';
    const client = new March12Project({ apiKey: 'My API Key' });
    expect(client.apiKey).toBe('My API Key');
  });
});
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new March12Project({ apiKey: 'My API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new March12Project({ apiKey: 'My API Key', fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new March12Project({ apiKey: 'My API Key', fetch: testFetch });
